...
INSERT INTO QUESTION (ID, CANCER_TYPE, DESCRIPTION, SYMPTOM_TYPE, QUESTION_TYPE) VALUES (5, 'BREAST', 'Have a lump under the arm or along the chest wall', 'LUMP_UNDER_ARM', 'YES_NO');
...
INSERT INTO ALARM_PROCESS (ID, ADVICE, CANCER_TYPE, FREQUENCY, INSTRUCTIONS, SYMPTOM_TYPE, URGENCY) VALUES (3,'Patient has experienced changes in their breast.', 'BREAST', 1, 'SEND_EMAIL', 'BREAST_CHANGE', 'MEDIUM');
...
INSERT INTO QUESTION (ID, CANCER_TYPE, DESCRIPTION, SYMPTOM_TYPE, QUESTION_TYPE, NUMERIC_LABELS) VALUES (8, 'COMMON', 'How are you?', 'HAPPINESS', 'NUMERIC', 'Feeling terrible;Not good;;Good;Feeling great');
...
INSERT INTO QUESTION (ID, CANCER_TYPE, DESCRIPTION, SYMPTOM_TYPE, QUESTION_TYPE, NUMERIC_LABELS) VALUES (9, 'COMMON', 'How calm and peaceful are you?', 'CALMNESS', 'NUMERIC', 'Very nervous;Nervous;;Calm;Very calm');
...
INSERT INTO QUESTION (ID, CANCER_TYPE, DESCRIPTION, SYMPTOM_TYPE, QUESTION_TYPE, NUMERIC_LABELS) VALUES (10, 'COMMON', 'How energetic are you?', 'EXHAUSTED', 'NUMERIC', 'I am lethargic;Not really;;Energetic;Very energetic');
...
INSERT INTO QUESTION (ID, CANCER_TYPE, DESCRIPTION, SYMPTOM_TYPE, QUESTION_TYPE, NUMERIC_LABELS) VALUES (11, 'COMMON', 'Are you feeling depressed?', 'DEPRESSED', 'NUMERIC', 'Very depressed;Depressed;;Not really;Not at all');
